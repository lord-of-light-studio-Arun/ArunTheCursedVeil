...
#include "CombatTest_IAttack.h"
#include "CombatTest_IDamage.h"
#include "Animation/AnimInstance.h"
#include "InputActionValue.h"
#include "Logging/LogMacros.h"
#include "CombatTest_Character.generated.h"
 ...
 */
UCLASS(abstract)
class ACombatTest_Character : public ACharacter, public ICombatTest_IAttack, public ICombatTest_IDamage
{
	GENERATED_BODY()
...
protected:
	...
	// Enhanced Input (assign assets in editor, or via ConstructorHelpers if you prefer hard paths)
...
public:
	...
	/** Handles run inputs from either controls or UI interfaces */
...
public:
	...
	// ~begin CombatTest_IAttack interface
